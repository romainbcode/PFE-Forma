...
export const Navbar = () => {
    ...
    return (
        <AppBar position="static" elevation={0} sx={{bgcolor: 'primary.background', color: 'primary.headLine'}}>
                ...
                <Toolbar disableGutters>
                    ...
                    <Box sx={{position: 'absolute', left: '50%', transform: 'translate(-50%, 0%)', display:'flex', flexDirection:'row', alignItems:'center'}} >
                        <Button
                            ...
                            sx={{bgcolor: 'transparent', color: color_headLine, fontWeight: 'bold', ":hover": {bgcolor:color_buttonBackground, color: color_headLine}}}
                        >
                        Formation
                        </Button>
                        <StyledMenu
